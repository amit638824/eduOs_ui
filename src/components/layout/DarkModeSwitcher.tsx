...
export default function DarkModeSwitcher({ variant = 'floating' }: DarkModeSwitcherProps) {
  ...
  return (
    <div className={`mode_switcher my_switcher${variant === 'inline' ? ' mode_switcher--inline' : ''}`}>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="ionicon dark__mode" viewBox="0 0 512 512">
          <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="ionicon light__mode" viewBox="0 0 512 512">
          <path
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
